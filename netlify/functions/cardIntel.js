...
export async function handler(event) {
  ...
  try {
    ...
    const responsePayload = {
      ...
      setBrand: normalizedAttributes.setBrand,
      cardNumber: normalizedAttributes.cardNumber,
      brand: normalizedAttributes.brand,
      grade: normalizedAttributes.grade,
      gradingAuthority: normalizedAttributes.gradingAuthority,
